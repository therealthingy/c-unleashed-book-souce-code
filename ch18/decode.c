...
static const CODE_TABLE code_table[12][2] = {
    {{t4_black_02, sizeof t4_black_02 / sizeof *t4_black_02},                                               {NULL, 0}},

    {{t4_black_03, sizeof t4_black_03 / sizeof *t4_black_03},                                               {NULL, 0}},

    {{t4_black_04, sizeof t4_black_03 / sizeof *t4_black_03}, {t4_white_04, sizeof t4_white_04 / sizeof *t4_white_04}},

    {{t4_black_05, sizeof t4_black_05 / sizeof *t4_black_05}, {t4_white_05, sizeof t4_white_05 / sizeof *t4_white_05}},

    {{t4_black_06, sizeof t4_black_06 / sizeof *t4_black_06}, {t4_white_06, sizeof t4_white_06 / sizeof *t4_white_06}},

    {{t4_black_07, sizeof t4_black_07 / sizeof *t4_black_07}, {t4_white_07, sizeof t4_white_07 / sizeof *t4_white_07}},

    {{t4_black_08, sizeof t4_black_08 / sizeof *t4_black_08}, {t4_white_08, sizeof t4_white_08 / sizeof *t4_white_08}},

    {{t4_black_09, sizeof t4_black_09 / sizeof *t4_black_09}, {t4_white_09, sizeof t4_white_09 / sizeof *t4_white_09}},

    {{t4_black_10, sizeof t4_black_10 / sizeof *t4_black_10},                                               {NULL, 0}},

    {{t4_black_11, sizeof t4_black_11 / sizeof *t4_black_11},                                               {NULL, 0}},

    {{t4_black_12, sizeof t4_black_12 / sizeof *t4_black_12},                                               {NULL, 0}},

    {{t4_black_13, sizeof t4_black_13 / sizeof *t4_black_13},                                               {NULL, 0}}
};
 ...
 * current pixel color
 */
typedef enum { BLACK_WANTED, WHITE_WANTED } PIXEL_WANTED;
 ...
 *              caller
 */
static unsigned char *OutputPixels(int length, PIXEL_WANTED wanted, unsigned char *out_ptr) {
    unsigned int mask;
    ...
    while (length >= outbits_left) {
        ...
        *out_ptr++ = (unsigned char)(pixel_out | (mask >> (PIXELS_PER_OCTET - outbits_left)));
        pixel_out = 0;
        length -= outbits_left;
    ...
    if (length) {
        pixel_out <<= length;
        pixel_out |= mask >> (PIXELS_PER_OCTET - length);
        outbits_left -= length;
    }
 ...
 */
static int GetNextBit(FILE *fin) {
 ...
 *              word
 */
static int GetPixelRun(PIXEL_WANTED color, FILE *fin) {
    ...
    for (;;) /* until code word found or error   */
    {
        ...
        } else if (NULL != (t4p = code_table[bits - 2][color].token))
        ...
        {
            t4p = bsearch(&code_word, t4p, code_table[bits - 2][color].search_length, sizeof *t4p, T4Compare);
 ...
 *              page
 */
int DecodePage(FILE *fin, FILE *fout, unsigned char *const buff) {
