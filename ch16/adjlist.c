...
int AdjList_EdgeScanNext(struct EdgeScan *EScan) {
    ...
    if (!node)
        return INT_MAX; /* >0.... denotes finished */
...
struct Graph_Spec AdjList_Spec = {AdjList_MakeGraph,     AdjList_FreeGraph,     AdjList_AddVertex,
                                  AdjList_RemoveVertex,  AdjList_ConnectVertex, AdjList_DisconnectVertex,
                                  AdjList_EdgeScanStart, AdjList_EdgeScanEnd,   AdjList_EdgeScanNext};
